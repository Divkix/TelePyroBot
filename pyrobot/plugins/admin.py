...
async def promote_usr(client, message):
    ...
    try:
        ...
        if str(user_id).lower().startswith("@"):
            ...
            await message.edit("**Promoted** {}".format(mention_markdown(user_first_name, user_id)))
            await client.send_message(PRIVATE_GROUP_ID, "#PROMOTE\nPromoted {} in chat {}".format(mention_markdown(user_first_name, user_id), message.chat.title))
...
async def demote_usr(client, message):
    ...
    try:
        ...
        if str(user_id).lower().startswith("@"):
            ...
            await message.edit("**Demoted** {}".format(mention_markdown(user_first_name, user_id)))
            await client.send_message(PRIVATE_GROUP_ID, "#DEMOTE\nDemoted {} in chat {}".format(mention_markdown(user_first_name, user_id), message.chat.title))
    except Exception as ef:
        await message.edit(f"**Error:**\n\n`{ef}`")
...
async def ban_usr(client, message):
    ...
    try:
        ...
        if str(user_id).lower().startswith("@"):
            ...
            await message.edit("**Banned** {}".format(mention_markdown(user_first_name, user_id)))
            await client.send_message(PRIVATE_GROUP_ID, "#BAN\nBanned {} in chat {}".format(mention_markdown(user_first_name, user_id), message.chat.title))
    except Exception as ef:
        await message.edit(f"**Error:**\n\n`{ef}`")
...
async def restrict_usr(client, message):
    ...
    try:
        ...
        if str(user_id).lower().startswith("@"):
            ...
            await message.edit("**Muted** {}".format(mention_markdown(user_first_name, user_id)))
            await client.send_message(PRIVATE_GROUP_ID, "#MUTE\nMuted {} in chat {}".format(mention_markdown(user_first_name, user_id), message.chat.title))
    except Exception as ef:
        await message.edit(f"**Error:**\n\n`{ef}`")
...
async def unrestrict_usr(client, message):
    ...
    try:
        ...
        if str(user_id).lower().startswith("@"):
            ...
            await message.edit("**UnRestricted** {}".format(mention_markdown(user_first_name, user_id)))
            await client.send_message(PRIVATE_GROUP_ID, "#UNRESTRICT\nUnrestricted {} in chat {}".format(mention_markdown(user_first_name, user_id), message.chat.title))
    except Exception as ef:
        await message.edit(f"**Error:**\n\n`{ef}`")
...
async def invite_user(client, message):
    ...
    try:
        ...
        if str(user_id).lower().startswith("@"):
            ...
            await client.send_message(PRIVATE_GROUP_ID, f"#INVITE\nAdded <a herf='tg://user?id={user_id}'>{user_first_name}</a> in chat {message.chat.title}")
    except Exception as ef:
